...
#define	kP		(0.5/kMaxSet)
#define	kI		(0.03/kMaxSet)
#define	kD		(0.0)
#define	kF		(0.5/kMaxSet)
#define	kPeriod		(0.1)
#define	kTolerance 	(3.0)

Shooter::Shooter( SpeedController *bottomMotor, Tachometer *bottomTach,
    ...
    : Subsystem("Shooter")
{
    ...
    m_bottomPID->SetPercentTolerance( kTolerance );
    ...
    m_topPID->SetPercentTolerance( kTolerance );
